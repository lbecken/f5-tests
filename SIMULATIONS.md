...
A collection of eight interactive nature simulations, written in plain JavaScript on a single
2-D `<canvas>`. The priority throughout is **physical realism**: every simulation is built
